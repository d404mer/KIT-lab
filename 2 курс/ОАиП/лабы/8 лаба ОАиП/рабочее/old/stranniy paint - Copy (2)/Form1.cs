...
namespace stranniy_paint
{
    public partial class Очень_Странный_Пеинт : System.Windows.Forms.Form
    {
        ...
        private void Check_Radio_button()
        {
            ...
            {
                Rectangle rectangle = new Rectangle(Convert.ToInt32(x_coordinates.Text), Convert.ToInt32(y_coordinates.Text), Convert.ToInt32(Width_input.Text), Convert.ToInt32(Height_input.Text));
                
                SHAPECONTAINER_CLASS.AddFigure(rectangle);
                //rectangle.Name = "Rectangle " + Convert.ToString(FM.figures.FindLastIndex(f => f is Rectangle));
                rectangle.Draw();
            }
